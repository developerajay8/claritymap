  ...
  return (
    <section className="relative z-10 md:py-24 py-12 overflow-hidden bg-[#050505]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(158,255,0,0.4) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{
                  ...
                  filter:
                    "drop-shadow(0 0 12px rgba(158,255,0,0.4))",
                }}
              >
                Landing Page
              </span>{" "}
            ...
            <p className="text-white/50 text-sm leading-relaxed max-w-md">
              We are a creative landing page agency focused on building
              premium, animated, and high-converting digital experiences.
              From SaaS startups and AI products to real estate, coaches,
              cafés, events, and brands — we craft visually stunning landing
              pages with modern UI, motion effects, 3D interactions, and
              conversion-driven layouts that help businesses grow faster.
            </p>
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(158,255,0,0.12), rgba(158,255,0,0.04))",
                  boxShadow:
                    "0 0 30px rgba(158,255,0,0.12), inset 0 0 20px rgba(158,255,0,0.04)",
                }}
              >
                <div>
                  <p
                    ...
                    style={{
                      ...
                      filter:
                        "drop-shadow(0 0 10px rgba(158,255,0,0.6))",
                    }}
                  >
                    250+
                  </p>
          ...
          >
            ...
            >
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-24 h-40">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(100,160,30,0.5), rgba(50,80,15,0.2))",
                  }}
                />
              </div>
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 60% 40%, rgba(158,255,0,0.12), transparent 70%)",
                }}
              />
            </div>
            ...
            >
              <svg viewBox="0 0 100 100" width="80" height="80">
                ...
                <text
                  fontSize="8.5"
                  fill="rgba(158,255,0,0.65)"
                  letterSpacing="2.5"
                >
                  <textPath href="#exp-circle">
                    CREATIVE AGENCY • MODERN UI • 3D DESIGN •
                  </textPath>
                </text>
              </svg>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-9 h-9 rounded-full bg-[#9EFF00]/15 border border-[#9EFF00]/30 flex items-center justify-center">
                  <span className="text-[#9EFF00] text-[9px] font-bold">
                    3D
                  </span>
                </div>
              </div>
