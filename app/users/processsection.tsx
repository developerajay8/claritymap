...
const STEPS = [
  {
    num: "01",
    title: "Strategy & Brand Research",
    desc: "We deeply understand your business, target audience, offers, and competitors to craft a landing page strategy focused on conversions and brand impact.",
  },
  {
    num: "02",
    title: "Modern UI/UX & 3D Design",
    desc: "Our team creates premium layouts with immersive animations, modern UI systems, smooth interactions, and visually engaging 3D-inspired experiences.",
  },
  {
    num: "03",
    title: "Development & Launch",
    desc: "We build fast, responsive, and SEO-optimized landing pages using modern technologies with complete testing, performance optimization, and deployment setup.",
  },
];
  ...
  return (
    <section className="relative z-10 md:py-24 py-12 overflow-hidden bg-[#050505]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 0% 50%, rgba(158,255,0,0.5) 0%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    boxShadow:
                      "inset 0 0 0 1px rgba(158,255,0,0.25), 0 0 20px rgba(158,255,0,0.06)",
                  }}
                />
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #0e1a04 0%, #1c3008 50%, #0a1402 100%)",
                boxShadow:
                  "0 20px 60px rgba(0,0,0,0.6), 0 0 40px rgba(158,255,0,0.1)",
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(158,255,0,0.15) 0%, transparent 60%)",
                }}
              />
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(225deg, #111, #0a0a0a)",
                boxShadow:
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 70% 30%, rgba(158,255,0,0.08), transparent 70%)",
                }}
              />
        ...
        >
          {TAGS.map((tag, i) => (
            <motion.div
              ...
              whileHover={{
                scale: 1.06,
                borderColor: "rgba(158,255,0,0.5)",
              }}
